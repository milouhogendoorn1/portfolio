...
<!--          <span class="self-center text-lg text-[#d946ef] font-semibold whitespace-nowrap fadein-bot hover:text-[#bb33d1]">Milou Hogendoorn</span>-->
<!--        </button>-->
<!--        <div class="flex md:order-2 fadein-bot">-->
<!--          <a href="https://github.com/milouhogendoorn"><img class="w-9 rounded-full" src="https://seeklogo.com/images/G/github-logo-2E3852456C-seeklogo.com.png" alt="github"></a>-->
<!--        </div>-->
...
<!--                class="fadein-bot fadein-1 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0">Over mij</router-link>-->
<!--            </li>-->
<!--            <li>-->
<!--              <router-link to="/portfolio"-->
<!--                class="fadein-bot fadein-2 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0">Projecten</router-link>-->
<!--            </li>-->
<!--            <li>-->
<!--              <router-link to="/blog"-->
  ...
  <div class="max-w-7xl mx-auto flex flex-col relative min-h-screen">
    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span
              class="self-center text-lg text-[#d946ef] font-semibold whitespace-nowrap fadein-bot hover:text-[#bb33d1]"
          >
            Milou Hogendoorn
          </span>
        </button>
...
<!--        </div>-->
    ...
    <main class="md:mt-[100px] flex-grow">
...
/* Animatie voor de router-view transitions */
