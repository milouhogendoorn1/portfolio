    ...
    return {
      ...
      tech: [
        ...
        // },
        {
          ...
          status: 'Basis',
          desc: 'Voor Android-ontwikkeling'
        },
        {
          id: 15,
          name: 'Java',
...
<template>
  <div
    class="bg-[#1e1e1f] px-5 py-5 md:px-12 md:py-10 text-left border border-[#383838] rounded-3xl text-[#d946ef] mx-3 mb-5">
    <article data-page="about">

      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          Over mij &nbsp;
          <div class="h-[1px] w-32 bg-[#d946ef] md:w-96 aos-init aos-animate" data-aos="zoom-in-left"
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-96 h-96 rounded-full mb-3 fadein-up object-cover mx-auto"
               src="/img/portfolio-zelfportret.png" alt="Zelfportret">

        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1 text-white">
            &nbsp; &nbsp; &nbsp; Hallo! Mijn naam is Milou Hogendoorn. Ik ben een vierdejaars student Software
            Engineering aan de Hogeschool van Amsterdam en volg de opleiding HBO-ICT.
            Ik ben een gemotiveerde student met een brede interesse in de wereld van ICT. Ik streef ernaar om mezelf
            continu te ontwikkelen als softwareontwikkelaar.

          </p>
          <p class="mb-3 fadein-left fadeins-2 text-white">
            &nbsp; &nbsp; &nbsp; Naast technische vaardigheden heb ik ook een oog voor design en gebruiksvriendelijkheid. Ik geloof dat goed ontworpen software niet alleen functioneel moet zijn, maar ook aantrekkelijk. Persoonlijke groei vind ik minstens zo belangrijk. Ik werk graag samen, denk mee aan het oplossen van
            problemen en sta altijd open voor nieuwe kennis en ervaringen. Ik kijk ernaar uit om verder te groeien binnen de IT-sector.
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-[#d946ef] mx-3">
    <article data-page="about">
      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          <div class="h-[1px] w-10 bg-[#d946ef] md:w-20 aos-init aos-animate" data-aos="zoom-in-left"
            data-aos-duration="600"></div>
          &nbsp; Skills
        </div>
      </header>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-[#d946ef] bg-[#d946ef] bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Tech Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-[#d946ef] bg-[#d946ef] bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Tools</button>
            </li>
          </ul>
        </div>
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 md:gap-8 xl:grid-cols-4 xl:gap-10 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-[#d946ef] px-2 py-2 hover:bg-[#d946ef] hover:bg-opacity-10 md:gap-3 lg:px-3">
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  <div class="tech font-medium text-white transition-all duration-300 translate-y-0 ">{{ item.name }}
                  </div>
                  <div
                    class="status-tech opacity-0 absolute mt-5 text-[10px] text-[#d946ef] transition-all duration-300 md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                </div>
              </div>
            </div>
